...
“航运宝支付服务”（以下简称本服务）是由上海泛舟网络科技有限公司（以下简称本公司）向航运宝用户提供的“航运宝”软件系统（以下简称本系统）及(或)附随的货款代收代付的中介服务。本协议由您和本公司签订。

 

一、 声明与承诺

（一） 您确认，在您注册成为航运宝用户以接受本服务之前，你已充分阅读、理解并接受本协议的全部内容，一旦您使用本服务，即表示您同意遵循本协议之所有约定。
...
（三） 您声明，在您同意接受本协议并注册成为航运宝用户时，您是具有法律规定的完全民事权利能力和民事行为能力，能够独立承担民事责任的自然人、法人或其他组织；本协议内容不受您所属国家或地区的排斥。不具备前述条件的，您应立即终止注册或停止使用本服务。

 

二、 “航运宝服务”概要

（一） 航运宝中介服务（亦称 “航运宝担保交易”）：即本公司向您提供的货款代收代付的中介服务，其中包含

1、 代管：您可以使用本服务指定的方式向您的航运宝账户充值，并委托本公司代为保管。

2、 代付：您可以要求本公司将代管或代收的您的款项支付给您指定的第三方。您同意，本公司代付后，非经法律程序或者非依本协议之约定，该支付是不可逆转的。
...
5、 查询：本公司将对您在本系统中的所有操作进行记录，不论该操作之目的最终是否实现。您可以在本系统中实时查询您的航运宝账户名下的交易记录，您认为记录有误的，本公司将向您提供本公司已按照您的指示收付款的记录。您理解并同意您最终收到款项的服务是由您提供的银行账户对应的银行提供的，您需向该银行请求查证。

6、 款项专属：对您支付到本公司并归属至您航运宝账户的款项及您通过航运宝账户收到的货款，本公司将予以妥善保管，除本协议另行规定外，不作任何其他非您指示的用途。

 

 

（三） 货到付款服务（COD服务）：是指买卖双方使用本系统，且约定买卖合同项下的交易货款由买方在收到交易货物时以现金方式支付到物流公司，物流公司在收到该款项后将交易货款支付给本公司，再由本公司支付至卖方航运宝账户的一种支付方式。在您使用本项服务时，除适用航运宝中介服务的相关约定外，还将优先适用以下条款：

1、 本公司为您代收的交易货款系由您的交易对方通过物流公司提供给本公司，并通过本公司支付到您的航运宝账户内。您理解并同意，您的交易对方通过物流公司将现金提供本公司的过程是需要一定时间的，本公司将在物流公司收取的现金交付给本公司后的次日，向您支付交易货款，因此产生的交易款项流转时间是您明知且认可的。

2、 本公司为您代付的交易货款系由您收到交易货物后以现金方式提供给物流公司，物流公司转交给本公司后后代您充值到您的航运宝账户，然后代为支付到您的交易对方的航运宝账户内；您向本公司提供的现金是由向您送达交易货物的物流公司代为转交的，物流公司可能因此向您单独收取费用，您理解并同意，该费用是物流公司基于其向您提供的转交服务所收取的，与本公司向您提供的本项服务无关。
...
在使用本服务前，您必须先行注册，取得本公司提供给您的“航运宝账户”（以下简称该账户），您同意：

1、 依本服务注册表之提示准确提供并在取得该账户后及时更新您的正确、最新及完整的资料。若有合理理由怀疑您提供的资料错误、不实、过时或不完整的，本公司有权暂停或终止向您提供部分或全部“航运宝服务”。本公司对此不承担任何责任，您将承担因此产生的任何直接或间接支出。

2、 因您未及时更新资料，导致本服务无法提供或提供时发生任何错误，您不得将此作为取消交易、拒绝付款的理由，您将承担因此产生的一切后果，本公司不承担任何责任。

3、 您应对您的航运宝账户负责，只有您本人可以使用您的航运宝账户，该账户不可转让、不可赠与、不可继承。在您决定不再使用该账户时，您应将该账户下所对应的可用款项全部提现或者向本公司发出其它支付指令，并向本公司申请注销（永久冻结）该账户。

您同意，若您丧失全部或部分民事权利能力或民事行为能力，本公司有权根据有效法律文书（包括但不限于生效的法院判决、生效的遗嘱等）处置与您的航运宝账户相关的款项。

（二） 账户安全

您将对使用该账户及密码进行的一切操作及言论负完全的责任，您同意：

1、 如您发现有他人冒用或盗用您的账户及密码或任何其他未经合法授权之情形时，应立即以有效方式通知本公司，要求本公司暂停相关服务。同时，您理解本公司对您的请求采取行动需要合理期限，在此之前，本公司对已执行的指令及(或)所导致的您的损失不承担任何责任。

2、 交易异常处理：您使用本服务时，可能由于银行本身系统问题、银行相关作业网络连线问题或其他不可抗拒因素，造成本服务无法提供。您确保您所输入的您的资料无误，如果因资料错误造成本公司于上述异常状况发生时，无法及时通知您相关交易后续处理方式的，本公司不承担任何损害赔偿责任。
...
（八）  本公司会将与您航运宝账户相关的资金，独立于本公司营运资金之外，且不会将该资金用于非您指示的用途，但《航运宝交易通用规则》约束的交易及本条第（十四）项约定的除外。

（九）  本公司并非银行或其它金融机构，本服务也非金融业务，本协议项下的资金移转均通过银行来实现，你理解并同意您的资金于流转途中的合理时间。

（十）  您完全承担您使用本服务期间由本公司保管或代收或代付的款项的货币贬值风险及可能的孳息损失。

（十一）您使用本服务进行交易或使用该账户登陆其他支持本服务的网站时，您即授权本公司将您的个人信息和交易信息披露给与您交易的另一方或您登陆的网站，该信息包括但不限于：您的真实姓名、联系方式、信用状况、航运宝账户。

（十二）您不得将本服务用于非本公司许可的其他用途。

（十三）交易风险

1）在使用本服务时，若您或您的交易对方未遵从本服务条款或网站说明、交易页面中之操作提示、规则），则本公司有权拒绝为您与交易对方提供相关服务，且本公司不承担损害赔偿责任。若发生上述状况，而款项已先行划付至您或他人的航运宝账户名下，您同意本公司有权直接自相关账户余额中扣回款项及（或）禁止您要求支付此笔款项之权利。此款项若已汇入您的银行账户，您同意本公司有向您事后索回之权利，因您的原因导致本公司事后追索的，您应当承担本公司合理的追索费用。
...
（四） 如您需要注销（永久冻结）您的航运宝账户，应先经本公司审核同意。本公司注销（永久冻结）该账户，即表明本公司与您之间的协议已解除，但您仍应对您使用本服务期间的行为承担可能的违约或损害赔偿责任，同时本公司仍可保有您的相关信息。
...
在阅读本协议以注册航运宝用户时，您尚未满18周岁的，您不能使用本服务，请您终止您的注册行为，不要向我们提供您的任何个人信息。

（二）  用户名和密码

在您注册为航运宝用户时，我们会要求您设置用户名和密码来识别您的身份，您仅可通过您设置的密码来使用该账户，如果您泄漏了密码，您可能会丢失您的个人识别信息，并可能导致对您不利的法律后果。该账户和密码因任何原因受到潜在或现实危险时，您应该立即和本公司取得联系，在本公司采取行动前，本公司对此不负任何责任。

（三）  注册信息

您注册该账户时应向本公司提供您的真实姓名、地址、国籍、电话号码和电子邮件地址，您还可以选择来填写相关附加信息（包括但不限于您公司所在的省份和城市、时区和邮政编码、传真号码、个人主页和您的职务）。为有针对性地向您提供新的服务和机会，您了解并同意本公司及其关联公司（指阿里巴巴集团旗下所有公司）或您登录的其他网站将通过您的电子邮件地址或该手机通知您这些信息。
...
本公司会对航运宝用户的身份数据进行综合统计，并出于销售和奖励的需要使用或披露。

（七）为更为有效的向您提供服务，您同意，本公司有权将您注册及使用本服务过程中所提供、形成的信息提供给本公司关联公司。除本协议另有规定外，本公司不对外公开或向第三方提供您的信息，但以下情况除外：
...
（三） 航运宝用户信息是由用户本人自行提供的，本公司无法保证该信息之准确、及时和完整，您应对您的判断承担全部责任。
